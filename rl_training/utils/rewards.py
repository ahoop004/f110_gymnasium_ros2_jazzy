...
class CenterlineProgressReward(BaseReward):
    def __init__(self, centerline_csv, step_penalty=+0.01, progress_scale=10.0, lap_reward=10.0,
                 collision_penalty=-200.0, no_move_penalty=-0.25, no_move_thresh=0.01):
        ...
        self.no_move_thresh = 0.1
        self.no_move_limit = 150
