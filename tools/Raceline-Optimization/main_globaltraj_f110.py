...
parser.add_argument('--map_name', type=str, default='Spielberg_map', help='Name of the map (default: e7_floor5_square)')
parser.add_argument('--map_path', type=str, default='/home/aaron/ros2_RL/Raceline-Optimization/inputs/tracks/Spielberg_map.csv', help='Path to the map centerline (should be a .csv), defaults to inputs/tracks/<map_name>.csv')
parser.add_argument('--export_path', type=str, default='/home/aaron/ros2_RL/ros_ws/src/pure_pursuit/racelines', help='Path to copy from the filepath in the /outputs')
